...
class {cname} extends \Phpcmf\Table
{
    ...
    public function __construct()
    {
        ...
        $this->is_show_search_bar = isset($config['is_show_search_bar'])? $config['is_show_search_bar'] : 0;
        ...
        \Phpcmf\Service::V()->assign([
            ...
            'is_show_search_bar' => $this->is_show_search_bar,
            // 后台的菜单
            'menu' => \Phpcmf\Service::M('auth')->_admin_menu(
                [
                    ...
                    '显示设置' => ['add:'.APP_DIR.'/'.\Phpcmf\Service::L('Router')->class.'/config', 'fa fa-cog', '90%', '90%'],
                ])
        ]);
    }
