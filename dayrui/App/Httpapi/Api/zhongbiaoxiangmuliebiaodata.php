...
$data = \Phpcmf\Service::M()->table('1_xinwenzhongxin')->where('catid', 9)->where('xinwenzuobian', 1)->select('id,url,title,description,thumb,updatetime')->order_by('inputtime DESC')->limit(3)->getAll();
